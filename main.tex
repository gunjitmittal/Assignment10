...
\begin{frame}{Solution}
  ...
  \end{align}
  \begin{align}
    \frac{\partial{f(X,\theta)}}{\partial{\theta}} = -ne^{-n\theta} \frac{\theta^{n\bar{x}}}{\prod x_i!} + n\bar{x}e^{-n\theta} \frac{\theta^{n\bar{x}-1}}{\prod x_i!}
  \end{align}
  \begin{align}
    \frac{\partial{f(X,\theta)}}{\partial{\theta}} = e^{-n\theta} \frac{\theta^{n\bar{x}}}{\prod x_i!} \brak{-n + 
    \frac{n\bar{x}}{\theta}}
  \end{align}
  In order to maximise $f(X,\theta),\frac{\partial{f(X,\theta)}}{\partial{\theta}}$ must be 0
  \begin{align}
